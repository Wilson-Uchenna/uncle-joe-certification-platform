...
const FEATURES: FeatureItem[] = [
  {
    ...
    description:
      "Access high-quality, career-focused courses designed to prepare you for today's most in-demand industries.",
  },
  {
    Icon: Award,
    title: "Earn Professional Certifications",
    description:
      "Complete assessments and earn certificates that showcase your knowledge and demonstrate your commitment to professional growth.",
  },
  {
    Icon: Briefcase,
    title: "Discover Internship Opportunities",
    description:
      "Gain hands-on experience through internships that help you build confidence and strengthen your career journey.",
  },
  {
    Icon: Globe,
    title: "Find Remote Jobs",
    description:
      "Connect with verified employers and apply for remote opportunities that match your skills and career goals.",
  },
];
export default function Onskillora() {
  return (
    <section>
      <div className="py-8 md:py-16 px-4 sm:px-6 lg:px-8 font-[600]">
        {/* Section label */}
